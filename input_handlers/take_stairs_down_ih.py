...
def handle_take_stairs_down_input(entities,player,game_map,message_log,game_state,constants,con,fov_map,fov_recompute):
    for entity in entities:
        if entity.stairs and entity.x == player.x and entity.y == player.y and entity.stairs.direction == 1:
            ...
            break
    return player, entities, game_map, message_log, game_state, fov_map, fov_recompute
